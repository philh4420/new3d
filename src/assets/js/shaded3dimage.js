...
const texture2 = loader.load(images.web1);
const texture3 = loader.load(images.web2);
const texture4 = loader.load(images.web3);
...
class Shaded {
    constructor() {
        ...
        this.inner = document.querySelector(".into");
    ...
    setupCamera() {
        ...
        this.renderer.setSize(this.viewport.width, this.viewport.hieght);
    ...
    createMesh() {
        ...
        this.mesh.position(this.offset.x, this.offset.y, 0);
    ...
    render() {
        ...
        this.hovered
            ? (this.uniforms.uAlpha.value = lerp(
                this.uniforms.uAlpha.value, 1.0, 0.1))
            : (this.uniforms.uAlpha.value = lerp(
                this.uniforms.uAlpha.value, 0.0, 0.1
            ));
